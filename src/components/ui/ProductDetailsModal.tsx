  ...
  return (
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-4 sm:p-6 md:p-12">
      ...
      >
        ...
        {/* Left: Image */}
        <div className="w-full md:w-1/2 bg-slate-50 relative min-h-[300px] overflow-hidden">
          {discount > 0 && (
        ...
        <div className="w-full md:w-1/2 p-6 md:p-10 flex flex-col">
          ...
          <div className="mb-8 text-gray-600 text-sm leading-relaxed">
            {selectedProduct.description || '১০০% নিরাপদ এবং ফ্রেশ প্রোটিনের নিশ্চয়তা। সরাসরি খামার থেকে স্বাস্থ্যসম্মত উপায়ে সংগ্রহ করে আপনার দোরগোড়ায় পৌঁছে দেওয়া হচ্ছে। সেরা মানের এবং হালাল পণ্যটি আপনার দৈনন্দিন পুষ্টির চাহিদা মেটাবে।'}
          </div>
          ...
          <div className="mt-auto grid grid-cols-2 gap-3">
            <div className="flex items-center gap-3.5 bg-[#f8f9fa] p-3 rounded-[20px]">
              <div className="w-[42px] h-[42px] bg-white rounded-full flex items-center justify-center text-[#2563eb] shadow-[0_2px_8px_rgba(0,0,0,0.04)] shrink-0">
            ...
            <div className="flex items-center gap-3.5 bg-[#f8f9fa] p-3 rounded-[20px]">
              <div className="w-[42px] h-[42px] bg-white rounded-full flex items-center justify-center text-[#16a34a] shadow-[0_2px_8px_rgba(0,0,0,0.04)] shrink-0">
                <Truck size={22} strokeWidth={2.2} />
              </div>
              <div className="text-left mt-0.5">
                <p className="text-[13px] font-bold text-[#1e293b] leading-[1.3]">ফাস্ট হোম<br />ডেলিভারি</p>
              </div>
            </div>
          </div>
